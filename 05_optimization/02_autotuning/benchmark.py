"""
Benchmark: autotuned implicit im2col Conv3d (Triton) vs torch.nn.Conv3d.
...
from conv3d_autotuned import conv3d_autotuned, DEVICE
...
def run_benchmark(label, C_in, C_out, D, H, W, kD, kH, kW,
    ...
    # Our autotuned implicit im2col kernel
    triton_ms = benchmark_fn(
        lambda: conv3d_autotuned(x, weight, bias,
...
print("Autotuned Implicit im2col Conv3d Benchmark")
